	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除班级信息（如果存在学生或教师则不能删除），确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="addDialog" style="padding: 10px">  
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>班级介绍:</td>
	    			<td><textarea id = "info" name = "info" style="width: 200px; height: 60px;" class=""></textarea>"</td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	...
	<div id="editDialog" style="padding: 10px">  
    	...
    	<input type = "hidden" id = "edit-id" name = "id" >
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>班级介绍:</td>
	    			<td><textarea id = "edit_info" name = "info" style="width: 200px; height: 60px;" class=""></textarea>"</td>
	    		</tr>
	    	</table>
	    </form>
	</div>
